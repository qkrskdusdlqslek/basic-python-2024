...
class qtwin_exam(QWidget):
    ...
    def initUI(self):
        ...
        btn01.clicked.connect(self.btn01_clicked) # 버튼을 클릭하면(시그널) btn01_clicked 함수를 실행시키겠다
    ...
    def closeEvent(self, QCloseEvent) -> None:
        re = QMessageBox.question(self, '종료확인', '종료하시겠습니까?', QMessageBox.Yes|QMessageBox.No) # Shift + 역/ ->|
